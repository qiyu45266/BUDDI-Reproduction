...
| n_steps | diversity (mm) | severe_interpen | self_fid |
|---|---:|---:|---:|
...
Headline finding: 40 steps is a sweet spot — 2.5× faster than the paper's
100-step schedule, with the lowest severe-interpenetration rate (0.8%). Below
20 steps, both quality and physical plausibility degrade sharply.
...
- Wall-clock cold-start → deliverables: **~33 min** (env build 6 min + downloads
  2 min + sampling 25 min + analysis < 1 min)
